...
⚠️ 这是**刻意严格**的：连"只改注释"也会翻红（CRLF/LF 统一为 LF），
...
## 记录时的实际清单（2026-09-20 合并既有 fork 依赖）

`requirements.txt`：
`fastapi` `uvicorn` `websockets` `jinja2` `requests` `urllib3`
...
BASELINE: dict[str, str] = {
    "requirements.txt":
        "f60874dd3749925c718a2b59ffe1ace02cdccbc6bd889911b723727ec67ed5c5",
    "frontend/package.json":
        "3dab546a62dac3d15688c8921e335dc56838f3c0911a9fc98920dabc13f57f6a",
}

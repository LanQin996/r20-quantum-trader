export const enLedger = {
  ...
  truncated: 'Active Window: Latest {kept} / Total {total} Trades',
  truncatedHint: 'To ensure low-latency dynamics & calculus telemetry rendering, the dashboard displays an active window of the latest {kept} trades. All historical records remain fully preserved in the ledger database.',

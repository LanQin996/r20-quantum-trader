...
def _load_archived_closed_trades(start_time_override=None):
    ...
    start_value = start_time_override or os.getenv("R20_EVOLUTION_START_TIME", "")
...
def load_closed_trades(start_time_override: str | None = None):
    ...
    if enabled():
        return _load_archived_closed_trades(start_time_override)
        ...
        try:
            with open(LEDGER_JSON_FILE, "r", encoding="utf-8") as f:
                ...
                for t in t_list:
                    ...
                    if not check_time or check_time < effective_start:
                        continue
...
@analysis_capture.cycle("self_evolution")
